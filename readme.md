...
- Unsupervised graph neural networks with recurrent features for solving combinatorial optimization problems, 2024, arXiv.[[PDF](https://openreview.net/pdf?id=9qtswuW5ux)][None]
...
- Collaboration! Towards Robust Neural Methods for Vehicle Routing Problems, 2024, arXiv.[[PDF](https://openreview.net/pdf?id=zEOnlJaRKp)][None]
