...
- PolyNet: Learning Diverse Solution Strategies for Neural Combinatorial Optimization, 2024, ICLR.[[PDF](https://openreview.net/pdf?id=Q9R10ZKd8z)][None]
- Enhancing Sample Efficiency in Black-box Combinatorial Optimization via Symmetric Replay Training, 2024, ICLR.[[PDF](https://openreview.net/pdf?id=xzRnzHUVE9)][None]
- Enhancing the Cross-Size Generalization for Solving Vehicle Routing Problems via Continual Learning, 2024, ICLR.[[PDF](https://openreview.net/pdf?id=WdvT2UgsTK)][None]
...
- 【Tspformer】Memory-efficient Transformer-based network model for Traveling Salesman Problem, 2023, Neural Networks(CCF-B).[[PDF](https://www.sciencedirect.com/science/article/abs/pii/S0893608023000771)][[Code](https://github.com/yhnju/tspFormer)]
